export function VaultCard({
  ...
  return (
    <div className="bg-black/20 backdrop-blur-sm border border-white/10 rounded-md p-3">
      <p className="text-[9px] font-bold tracking-[2px] text-[#aab0a3] mb-2">CASH STORAGE</p>
      <div className="flex items-center justify-between text-[11px] font-bold">
        <span className="text-[#d0d5ca]">Wallet</span>
      ...
      <div className="flex items-center justify-between text-[11px] font-bold mt-1">
        <span className="text-[#d0d5ca]">Vault</span>
